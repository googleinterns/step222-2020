const utils = require('../src/CalendarUtilities.mjs');
...
describe('Previous month', function() {
  ...
  it('The previous month is generated correctly when the year does not change',
      function() {
...
describe('Next month', function() {
  ...
  it('The next month is generated correctly when the year does not change',
      function() {
...
describe('The number of days in a month', function() {
  ...
  it('The number of days in February is 29 if it is a leap year',
      function() {
        expect(utils.getNumberOfDaysInMonth(new Date(2020, 1))).toBe(29);
      });

  it('The number of days in February is 28 if it is not a leap year',
      function() {
